...
public class AppBarLayoutManager extends ViewGroupManager<AppBarLayout> {
    ...
    protected AppBarLayout createViewInstance(ThemedReactContext reactContext) {
        return new AppBarLayout(reactContext);
    }
    ...
    /*
    * To use the getCommandsMap API, define in AppBarLayout.js:
    *
    * setChildrenScrollFlags() {
    *   UIManager.dispatchViewManagerCommand(
    *     React.findNodeHandle(this.refs[APP_BAR_LAYOUT_REF]),
    *     Commands.AppbarLayout.SET_CHILDREN_SCROLL_FLAGS,
    *     null
    *   );
    * }
    *
