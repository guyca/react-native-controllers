package com.reactnativecontrollers.managers;
...
import com.reactnativecontrollers.events.TabSelectedEvent;
import com.reactnativecontrollers.layouts.ReactTabLayout;
import com.reactnativecontrollers.layouts.ReactTabLayout.InitialState;
import com.reactnativecontrollers.utils.ResourceUtils;
...
public class TabLayoutManager extends ViewGroupManager<ReactTabLayout> {
    ...
    protected ReactTabLayout createViewInstance(ThemedReactContext reactContext) {
        return new ReactTabLayout(reactContext);
    }
